...
public class LetterCombinations {
    public List<String> letterCombinations(String digits) {
        ...
        backtrack(res, map, digits, new StringBuffer(), 0);
        return res;
    }

    private void backtrack(List<String> res, Map<Character, String> map, String digits, StringBuffer output, int level) {
        if (level == digits.length()) {
            ...
            for (int i = 0; i < lettersCount; i++) {
                ...
                backtrack(res, map, digits, output, level + 1);
